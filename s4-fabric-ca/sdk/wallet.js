...
function readCertCryptogen(org, user) {
    ...
    var certPath = CRYPTO_CONFIG_PEER_ORGS + "/" + org + ".default.svc.cluster.local/users/" + user + "@" + org + ".default.svc.cluster.local/msp/signcerts/cert.pem"
...
function readPrivateKeyCryptogen(org, user) {
    ...
    var pkFolder = CRYPTO_CONFIG_PEER_ORGS + "/" + org + ".default.svc.cluster.local/users/" + user + "@" + org + ".default.svc.cluster.local/msp/keystore"
