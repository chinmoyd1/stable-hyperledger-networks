...
ORDERER_DNS_LIST="orderer0-service"
...
cp $CONFIGPATH/ordererOrganizations/$DOMAIN/orderers/$NAME.$DOMAIN/msp/cacerts/ca-7054.pem $CONFIGPATH/ordererOrganizations/$DOMAIN/orderers/$NAME.$DOMAIN/tls/ca.crt
...
for ((j = 1; j < 3; j++)); do
    ...
    for ((i = 0; i < 2; i++)); do
        ...
        cp $CONFIGPATH/peerOrganizations/$ORG.$DOMAIN/peers/$NAME.$ORG.$DOMAIN/msp/cacerts/ca-7054.pem $CONFIGPATH/peerOrganizations/$ORG.$DOMAIN/peers/$NAME.$ORG.$DOMAIN/tls/ca.crt
    done
